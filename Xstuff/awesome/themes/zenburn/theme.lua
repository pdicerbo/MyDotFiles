...
theme.dir                                       = os.getenv("HOME") .. "/.config/awesome/themes/zenburn"
-- {{{ Styles
...
theme.bg_widget        = "#1B1C1D9E"
theme.border_widget    = "#1B1C1D9E"
...
function theme.at_screen_connect(s)
    ...
    s.mylauncher = awful.widget.launcher({ image = ArchIcon,
